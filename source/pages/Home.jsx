...
function Home() {
   return (
      <div className="container flex-col items-center">
         <h1 className="text-6xl font-extrabold uppercase text-center max-w-[820px] mb-5 max-sm:text-5xl max-xxsm:text-4xl">
            A fun way to share what you listen to!
         </h1>
         <p className="text-2xl font-medium text-center mb-12 max-xxsm:text-lg">Create posters of your most listened songs and artists.</p>
